...
if (isset($_GET['delete'])) {
    $delete = $conn->prepare('DELETE FROM instrumento WHERE idinstrumento=?');
...
?>
  <div class="container pt-1">
      <h1 class="text-center">Instrumentos</h1>
      <table class="table table-striped table-bordered table-hover mt-1" id="tableresponsive" style="width: 100%;">
        ...
        <tbody>
          ...
          $result = $conn->prepare('SELECT * FROM instrumento');
          $result->execute();
          ...
          while ($view = $result->fetch(PDO::FETCH_ASSOC)) {
            ...
            <tr>
              ...
              <td>
                <?php echo $view["numero"] ?>
              </td>
              <td>
                <?php echo $view["seccion"] ?>
              </td>
              <td>
              <button type="button" data-bs-toggle="modal" data-bs-target="#delete<?php echo $view['idinstrumento']; ?>" class="btn btn-outline-danger" title="Eliminar Datos"><i class="bi bi-trash3-fill"></i></button>
          </td>
            <!-- Modal eliminar datos -->
            <div class="modal fade" id="delete<?php echo $view['idinstrumento']; ?>">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <p><?php echo $view['nombre']; ?></p>
                  </div>

                  <!-- Modal footer -->
                  <div class="modal-footer">
                    <a href="hadmin?page=listai&delete=<?php echo $view['idinstrumento']; ?>" title="Aceptar" class="btn btn-success">Aceptar</a>
