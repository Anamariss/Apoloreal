...
if (isset($_GET['delete'])) {
    $delete = $conn->prepare('DELETE FROM estudiante WHERE idestudiante=?');
  ...
  <div class="container pt-1">
      ...
      <table class="table table-striped table-bordered table-hover mt-1" id="tableresponsive" style="width: 100%;">
        ...
        <tbody>
          ...
          $result = $conn->prepare('SELECT * FROM estudiante');
          $result->execute();
          ...
          while ($view = $result->fetch(PDO::FETCH_ASSOC)) {
            ...
            <tr>
              ...
              <td>
              <button type="button" data-bs-toggle="modal" data-bs-target="#delete<?php echo $view['idestudiante']; ?>" class="btn btn-outline-danger" title="Eliminar Datos"><i class="bi bi-trash3-fill"></i></button>
          </td>
            <!-- Modal eliminar datos -->
            <div class="modal fade" id="delete<?php echo $view['idestudiante']; ?>">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <a href="hadmin?page=inventario&delete=<?php echo $view['idestudiante']; ?>" title="Aceptar" class="btn btn-success">Aceptar</a>
